...
class SqlDelightCorrectionStore private constructor(
            ...
            rollbackP408 {
                database.transactionWithResult {
                    ...
                    if (request.resultState == P408CorrectionResultState.CHECKED) {
                        ...
                        val actualDistance =
                            P408Computation.naturalDayDistance(successor.sourceOccurredAt, posting.occurred_at)
    ...
    private fun insertCorrectionSnapshot(
