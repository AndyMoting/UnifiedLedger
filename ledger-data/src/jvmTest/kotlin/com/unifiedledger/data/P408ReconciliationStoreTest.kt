...
class P408ReconciliationStoreTest {
    ...
    fun secondMirrorLinkToOtherPostingOfSameTransferIsAllowedWithoutNewFinancialRows() {
        ...
        try {
            ...
            val mirror = assertIs<P408ReconciliationResult.Accepted>(
                store.confirmLink(
                    request(
                        requestId = "request-b",
    ...
    fun changedRequestRetryIsTypedConflictWithZeroWrites() {
        ...
        try {
            ...
            val changed = assertIs<P408ReconciliationResult.Rejected>(
    ...
    fun crossLedgerStaleVersionAndIneligiblePostingAreRejectedWithoutWrites() {
        ...
        try {
            ...
            val crossLedger = assertIs<P408ReconciliationResult.Rejected>(
            ...
            val stale = assertIs<P408ReconciliationResult.Rejected>(
