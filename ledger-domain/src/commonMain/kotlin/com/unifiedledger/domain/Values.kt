...
data class TransactionVersionId(
    val value: String,
)

data class PostingSetId(
    val value: String,
)

data class PostingId(
    val value: String,
)

data class StoredValueLotId(
    val value: String,
)
...
internal fun checkedNegate(value: Long): Long? = if (value == Long.MIN_VALUE) null else -value
...
internal class ExactLongAccumulator {
    ...
    fun isZero(): Boolean = positiveChunks.isEmpty() && negativeChunks.isEmpty()
