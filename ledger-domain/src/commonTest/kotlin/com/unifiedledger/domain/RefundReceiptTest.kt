...
class RefundReceiptTest {
    ...
    fun createsIndependentRefundReceiptFormalTransaction() {
        val result =
            assertIs<DomainResult.Success<RefundReceipt>>(
                createRefundReceipt(
                    catalog,
                    ...
                    RefundReceiptIds(
                        ...
                        TransactionVersionId("refund-v1"),
                        PostingSetId("refund-set"),
                        PostingId("refund-asset"),
                        PostingId("refund-expense"),
                    ),
                ),
            ).value
        ...
        assertEquals(
            ...
            result.formalTransaction.postingSets
                .single()
                .postings
