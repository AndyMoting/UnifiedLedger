...
class MixedPaymentTest {
    ...
    fun mixedExpenseCreatesTypedBalancedPostingsAndReportEffects() {
        val result =
            createMixedPaymentExpense(
                ...
                MixedPaymentExpenseIds(
                    ...
                    PostingSetId("set"),
                    PostingId("expense"),
                    listOf(PostingId("asset"), PostingId("liability")),
                ),
            )
        ...
        val replayed =
            assertIs<DomainResult.Success<BalanceSnapshot>>(
    ...
    fun creditPrincipalRepaymentIsNotAnAccountTransferAndHasNoConsumption() {
        val result =
            createCreditPrincipalRepayment(
                catalog(),
                CreditPrincipalRepaymentCommand(
                    ledgerId,
                    AccountId("asset-a"),
                    AccountId("liability-b"),
