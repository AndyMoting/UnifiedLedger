...
class MergedPaymentTest {
    ...
    fun rejectsCategoryFromAnotherLedgerOrWithoutAValidRoot() {
        ...
        val wrongLedgerCatalog = assertIs<DomainResult.Success<LedgerCatalog>>(LedgerCatalog.create(
            catalog.accounts,
            listOf(
                Category(CategoryId("root"), ledger, null, null, true),
        ...
        val nestedRootCatalog = assertIs<DomainResult.Success<LedgerCatalog>>(LedgerCatalog.create(
            catalog.accounts,
            listOf(
    ...
    private fun command() = MergedPaymentExpenseCommand(ledger, Money.ofMinor(10_000, currency), AccountId("asset"), TransactionTimes.collapsed(Instant.parse("2026-04-10T10:30:00Z")), listOf(
