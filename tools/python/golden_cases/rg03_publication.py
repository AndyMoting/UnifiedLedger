...
def recover_rg03_publication(manifest_path: Path) -> bool:
    """Recover an interrupted RG-03 publication transaction, if its journal exists."""
...
def publish_rg03(
    ...
    *,
    ...
    recovered = recover_rg03_publication(manifest_path)
    ...
    try:
        ...
        if fail_after_manifest_backup:
            raise RuntimeError("injected RG-03 manifest backup failure")
        ...
        if fail_after_commit:
            raise RuntimeError("injected RG-03 post-commit failure")
