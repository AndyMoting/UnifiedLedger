...
from golden_cases.rg10_publication import publish_rg10, recover_rg10_publication
...
class Rg10PublicationTests(unittest.TestCase):
    ...
    def test_publication_hashes_is_idempotent_and_preserves_source(self):
        with tempfile.TemporaryDirectory() as name:
            ...
            self.assertEqual("44-operation full comparison",
    ...
    def test_output_backup_moved_journal_recovery_restores_missing_original(self):
        with tempfile.TemporaryDirectory() as name:
            ...
            journal = directory / ".rg-10-publication.journal.json"
            journal.write_text(
                json.dumps(
                    {
