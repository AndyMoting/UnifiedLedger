...
阶段 4“导入与对账闭环”已于 2026-08-23 收口；阶段 6（Android 视觉与平台适配）已于 2026-09-11 按 D-142 收口，下一阶段为阶段 7（Android 日常工作流）：compileSdk/targetSdk 已升至 37（minSdk 34），FOUND-001 损坏数据库 fail-closed 已按 D-132 闭环，D1 工具链批（D-133）、D2 主题与组件批（D-134）、D3 平台回归批（D-135）、玻璃启用批（D-136）与对话框 Esc 修复批（D-137，缺陷 D131DESKESC-001 关闭）均已交付并推送；D-138/D-139/D-140 键入保留缺陷修复批、技术栈升级批（D-141：CMP 1.12.0 / backdrop 2.0.1 / Kotlin 2.4.20 / AGP 9.3.1 / targetSdk 37 / kotlinx-datetime 0.8.0）均已交付并推送，阶段 6 已按 D-142 收口，下一阶段为阶段 7（Android 日常工作流）。P4-01 acceptance contract、P4-02 shared import spine、P4-03 微信 XLSX 普通收支、P4-04 transfer formalization、P4-05 支付宝普通收支及 RL-04 余额宝转账路由均已闭环；P4-08 matcher 与 reconciliation persistence 已按 D-103、P4-07 duplicate candidate/closed-records 已按 D-104/D-105 于 2026-08-22 合入 `main`；此后 P4-08 第二批 normalized evidence projection 已按 D-112 完成并合入 `main`（merge `b8755dd`，schema v26，2026-08-27 推送）。此后 P4-08 correction / successor invalidation 已按 D-113 完成并合入 `main`（merge `a3d11bb`，schema v27）——激活预留的失效事件/后继链接与 MISSING/DIFFERENCE 对账结果态，并解除 D-103 登记的该项延期。此后 BP-01 银行 parser 门承接批已按 D-116 于 2026-08-29 交付并推送（CMB 网银 CSV + CCB 网银 XLS 解析器、余额镜像 `note` 诊断与 RL-07 镜像代表路径；银行 parser 门 D-109 O-8 就此关闭，零 schema 变更；PDF/其他银行/信用卡属 D-116 边界外待样本）。
