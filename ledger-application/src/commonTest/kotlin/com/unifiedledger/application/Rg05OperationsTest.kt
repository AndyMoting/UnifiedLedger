...
class Rg05OperationsTest {
    ...
    fun confirmationGuardAppliesOnlyToFormalCreationActions() {
        ...
        val confirm =
            Rg05PreparedOperation.Confirm(
                ...
                MergedPaymentExpenseIds(TransactionId("tx"), TransactionVersionId("version"), PostingSetId("set"), listOf(PostingId("expense-a"), PostingId("expense-b")), PostingId("asset-posting")),
                "relation",
                "confirmation",
                "reconciliation",
                "bank-link",
    ...
    fun manualInputAdaptsExactAmountsAndRequiresExplicitConfirmation() {
        ...
        val input =
            Rg05ManualInput(
                Rg05Field.Value("request"),
                Rg05Field.Value("2026-04-10T10:30:00Z"),
                Rg05Field.Value("10.00"),
                Rg05Field.Value("CNY"),
                Rg05Field.Value("asset"),
                listOf(
        ...
        val adapted =
            assertIs<Rg05AdaptResult.Success>(
                adaptRg05Manual(
                    case,
                    input,
                    Rg05PreparedIds(
