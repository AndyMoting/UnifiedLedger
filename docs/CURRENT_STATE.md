...
- RG-05 完整状态 oracle、RG-06 publication 与 RG-07 closure 不表示全部黄金场景或正式账务核心已完成；RG-01、RG-02 和 RG-04 仍缺各自声明的完整比较，RG-08、RG-11 和 RG-12 尚无 Kotlin runtime。
- 其他 RG 的 v1 rewrite、v2 publication 和未完成完整比较仍分别受其现有 gate 约束；RG-09 与 RG-10 publication 仍未授权。
