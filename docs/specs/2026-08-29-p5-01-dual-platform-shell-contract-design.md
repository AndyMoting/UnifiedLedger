...
**状态：proposal** — 本文件为 P5-01 设计契约（contract-only：零实现、零 schema、零生产代码）。经用户批准后，由独立登记批将本文件状态翻转为 approved 并在 `docs/DECISIONS.md` 登记 D-117；本批自身不改动 `DECISIONS.md`、`ARCHITECTURE.md`、CI 或任何模块。
