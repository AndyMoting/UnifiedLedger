...
- `RG-05`：领域、应用与持久化 runtime 及 schema v8 已进入共享库。expected 仍为 `draft_for_review`，v2 未发布；完整 25-operation E2E、确定性 identity 验证、独立 expected/runtime 审查、明确用户批准和后续单独 publication 授权均待完成。
