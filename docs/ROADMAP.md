...
建立 Android 与 Desktop 可运行外壳，持续编译并调用同一业务核心；在现有稳定技术基线上完成 Android 基础交互。P5-01、P5-02、P5-03 已交付，下一批为 P5-04。当前基线保持 Kotlin 2.4.10、Compose Multiplatform 1.11.1、Material3 1.9.0、min/compile/target SDK 34/36/36。
...
- `P5-04.1`：三 Tab 基础交互（首页、账户、分析）与中央新增入口。
