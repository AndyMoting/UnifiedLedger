...
- `RG-06`：Golden Schema v2 契约与语义校验、领域 aggregate、catalog-free validated snapshot rehydration、八 action 应用契约，以及 schema v9/SQLDelight persistence adapter 已完成。fixture/expected/path-map rewrite 与 publication 仍受各自 gate 约束。
