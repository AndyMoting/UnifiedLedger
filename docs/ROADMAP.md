...
- `RG-08`：冻结 v1、Python 测试与 mapping 之上，`D-084` 已关闭 4 个 mapping gap（`RG08-GAP-01..04`）并完成完整 lending runtime、44-op oracle 与 schema v15 持久化，mapping gate 已 approved；无 v2 expected 工件，publication 不在当前授权范围。
