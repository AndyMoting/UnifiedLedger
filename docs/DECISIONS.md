...
**实施规格：** `docs/specs/2026-09-08-d138-occurred-at-lenient-manual-input-design.md`（状态 proposal；冻结 SHA-256 占位由主代理在规格冻结/提交时填入）。规格冻结 SHA-256（UTF-8+LF 工作副本字节域）：评审前冻结 `C289E28D4A5E7EFF470F92010B893B9AF5DE4ED012485F8A82960C654B68C795` → 评审处方闭环（P1-1/P1-2/P2-1..P2-5/P3-1..P3-4）后 `F1141AAE8AB3E8F5E0743F56647BE8D09A7BFF1471ACFCB7FA14D6E98451B563`（git blob SHA-1 `126ff084c61ce1a73fb5f7f34717c1ff0ebeebdd`）
