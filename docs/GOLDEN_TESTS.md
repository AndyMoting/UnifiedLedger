...
银行侧 parser 门附注（BP-01，D-116，2026-08-29，merge `0c4a634`/`19a2c95`，push `779d529..0c83f7b`）：RL-07 银行侧维度 = `CmbBillParserJvmTest`/`CcbBillParserJvmTest`（解析级 P-01..P-55，`ledger-application` jvmTest）+ `ImportSpineBankEndToEndTest`（E2E E-01..E-12、余额镜像 B-01..B-04、回归 R-01/R-02，`ledger-data` jvmTest；含 E-11 双形状门与单笔正式转账、bank posting `CHECKED`、零第二笔/零收入不变量）。银行 parser 门延期（D-109 O-8 → D-099:1540）就此解除；PDF/其他银行/信用卡未提供样本，属 D-116 边界外。
