...
fun P503ConfirmationScreen(
    ...
    Column(
        ...
        Text("支付账户：${draft.paymentAccountId?.value ?: "—"}", style = MaterialTheme.typography.bodyMedium)
        Text("费用分类：${draft.categoryId?.value ?: "—"}", style = MaterialTheme.typography.bodyMedium)
